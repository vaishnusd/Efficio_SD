...
export default IssueReport = () => {
	...
	const apiGot =
		'https://androidapi220230605081325.azurewebsites.net/api/approval/GetIssueList';
	...
	return (
		<SafeAreaView style={styles.container}>
			<LinearGradient
				colors={['#4C6078', '#001935']}
				style={styles.reportTableHeader}
			>
			...
			{loader ? (
				...
				<FlatList
					...
					renderItem={({ item }) => <EachReport dataToSend={item} />}
